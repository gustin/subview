...
# http://github.com/foca/mustache-on-rails-example/blob/master/lib/mustache/rails.rb

require "mustache"
 
ActiveSupport::Dependencies.load_paths << Rails.root.join("app", "views")
 
class SubView::Rails < SubView
...
ActionView::Template.register_template_handler(:subview, SubView::Rails::TemplateHandler)
